...
/*! тип примитивов
 @note LIST - список, на каждый примитив по необходимому количеству индексов, для линий 2, для треугольников 3
...
/*! Тип индексов в индексном буфере
 @note С GXIT_UINT16 можно организовать динамические буферы (которые будут часто обновляться), и пересылать сравнительно меньший объем данных по шине, что будет экономить время.
  Однако при этом следует помнить, что количество уникальных вершин поддерживаемых в индексном буфере не может превышать 65535.
*/
enum GXINDEXTYPE
{
